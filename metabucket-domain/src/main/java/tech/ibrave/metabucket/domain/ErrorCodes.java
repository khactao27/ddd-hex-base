...
public enum ErrorCodes implements ErrorCode {
    ...
    JSON_ERROR("MB0003", HttpStatus.BAD_REQUEST, "mb.json.parsing_error"),
    ...
    ROLE_NAME_EXISTED("MB0008", HttpStatus.BAD_REQUEST, "mb.roles.create.duplicated_rolename"),
    ...
    GROUP_NAME_EXISTED("MB0013", HttpStatus.BAD_REQUEST, "mb.groups.create.duplicated_groupname"),
    ...
    DUPLICATE_METADATA_NAME("MB0016", HttpStatus.BAD_REQUEST, "mb.metadata.validate.duplicated_metadataname"),
    DUPLICATE_MULTI_VALUE("MB0017", HttpStatus.BAD_REQUEST, "mb.metadata.validate.duplicate_multi_value"),
    DUPLICATE_CATEGORY_NAME("MB0018", HttpStatus.BAD_REQUEST, "mb.category.validate.duplicated_categoryname"),
    ...
    DUPLICATE_STORAGE_NAME("MB0021", HttpStatus.BAD_REQUEST, "mb.storage.validate.duplicated_storagename"),
